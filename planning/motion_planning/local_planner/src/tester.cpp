...
int main(int argc, char **argv) {
    ...
    image_transport::Publisher pub_world_map = it.advertise("data_fuser/map", 1000);
    ros::Publisher pub_target_pose = nh.advertise<geometry_msgs::Pose2D>("strategy_planner/target", 1000);
