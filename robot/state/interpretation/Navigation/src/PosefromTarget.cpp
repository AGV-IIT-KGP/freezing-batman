...
PosefromTarget::PosefromTarget(int argc, char* argv[]) {
	...
	target_topic=std::string("/GPS_waypoints/file_input");//std::string(argv[2]);
	gps_topic=std::string("sensors/gps/0");//std::string(argv[3]);
...
int main(int argc, char** argv) {
	...
	node_name = std::string("Position_From_Target_")+std::string("Strategy");
	ros::init(argc, argv, std::string("Strategy"));
