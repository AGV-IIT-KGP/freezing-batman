...
namespace navigation {
    ...
    public:
        ...
        Seed reconstructPath(StateOfCar const& currentStateOfCar_,  std::map<StateOfCar,StateOfCar>& came_from) ;
    ...
    public:
        AStarSeed();
        AStarSeed(char* seedFile);

        Seed findPathToTargetWithAstar(const cv::Mat& fusionMap, const State& start, const State& goal);
