...
namespace navigation {
    ...
    std::vector<nav_msgs::Path> RoadNavigation::getPaths(geometry_msgs::Pose current_pose, std::vector<geometry_msgs::Pose> targets) {
    ...
    nav_msgs::Path RoadNavigation::planRoadDetection(const nav_msgs::Path::ConstPtr& lane_traj, const geometry_msgs::PoseStamped::ConstPtr& pose) {
        nav_msgs::Path target_traj = decideTargetTrajectory(lane_traj);
        geometry_msgs::Pose current_pose = pose->pose;
